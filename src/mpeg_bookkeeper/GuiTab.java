...
/**
 * An abstract class representing one tab of the overall GUI and
 * providing a common look for the program. Consists of a text panel
 * for program output as well as fields and buttons for user input
 * and interaction.
 *
 * @author Cody Jones
 * @version 1.0
...
public abstract class GuiTab extends JPanel implements ActionListener {
   ...
   private void guiSetUp() {
   	...
   	process = null;
   	gui = this;
      bgColor = mpeg_bookkeeper.MPEGBookkeeperGui.BG_COLOR;
      
      calendar = Calendar.getInstance();
      
      calendar.set(Calendar.DAY_OF_WEEK, Calendar.SUNDAY);
      
      lastSunday = (calendar.get(Calendar.MONTH) + 1) + "/"
      ...
      log.setBackground(mpeg_bookkeeper.MPEGBookkeeperGui.PARCHMENT_COLOR);
      ...
      runButton.setBackground(mpeg_bookkeeper.MPEGBookkeeperGui.BUTTON_COLOR);
      
      stopButton = new JButton("Stop");
      stopButton.setAlignmentX(Component.RIGHT_ALIGNMENT);
      stopButton.addActionListener(this);
      stopButton.setBackground(mpeg_bookkeeper.MPEGBookkeeperGui.BUTTON_COLOR);
